...
/**
 * Lambda handler for AI analysis (slower endpoint)
 */
export const analysisHandler = async (
  ...
  try {
    console.log('Analysis Lambda invoked', { requestId: context.awsRequestId });
    ...
    console.error('Analysis Lambda error:', error);
...
/**
 * Lambda handler for discovery insights (medium speed endpoint)
 */
export const discoveryHandler = async (
  event: APIGatewayProxyEvent,
  context: Context
): Promise<APIGatewayProxyResult> => {
  try {
    console.log('Discovery Lambda invoked', { requestId: context.awsRequestId });
    ...
    console.error('Discovery Lambda error:', error);
